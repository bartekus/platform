// Code generated by the Encore v1.46.20 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-fids-platform-c9ui.encr.app`
}
...
export namespace stripe {
    ...
    nextPageToken?: string
        ...
        public async logtoWebhook(method: "POST", body?: BodyInit, options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/stripe/logto/webhooks`, body, options)
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if ( typeof globalThis === "object" && !("window" in globalThis) ) {
            this.headers["User-Agent"] = "fids-platform-c9ui-Generated-TS-Client (Encore/v1.46.20)";
        }
